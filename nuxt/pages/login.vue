  ...
  <div class="main">
    ...
    <div class="sign-up-container">
      <el-form ref="userForm" :model="user">
        ...
        <div class="btn">
          <input type="button" class="sign-in-button" value="登录" @click="submitOfLogin()">
        </div>
      </el-form>
      <!-- 更多登录方式 -->
      <div class="more-sign">
...
<script>
  ...
  import { submitLogin,getLoginUserInfo } from '@/api/login'
  ...
  export default {
    ...
    methods: {
      submitOfLogin(){
            submitLogin(this.user).then(response => {
