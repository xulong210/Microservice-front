    ...
    <form name="flowForm" id="flowForm" method="post" action="">
        ...
        <tr class="good">
          <td class="name First">
            <a target="_blank" :href="'https://localhost:3000/course/'+order.courseId">
              ...
              <img src="~/assets/photo/course/1442295581911.jpg"></a>
            <div class="goodInfo">
      ...
      <div class="Finish">
        <div class="fr" id="AgreeDiv">    
          <label for="Agree"><p class="on"><input type="checkbox" checked="checked">我已阅读并同意<a href="javascript:" target="_blank"></a></p></label>
        </div>
        <div class="clear"></div>
        <div class="Main fl">
          <div class="fl">
...
export default {
    ...
    methods: {
        getOrder(){
            getOrderInfo(this.$route.params.id).then(response => {
