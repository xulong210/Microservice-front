      ...
      <div class="swiper-wrapper">
          <div v-for="banner in bannerList" :key="banner.id" class="swiper-slide" style="background: #040B1B;">
              <a target="_blank" :href="banner.linkUrl">
                  <img src="~/assets/photo/banner/1.jpg" alt="banner">
              </a>
          </div>
      </div>
                  ...
                  <section class="i-teach-wrap">
                    <div class="i-teach-pic">
                      <a :href='["/teacher/"+teacher.id]' :title="teacher.name">
                        <img :alt="teacher.name" src="~/assets/photo/teacher/1442297935589.jpg">
                      </a>
                    </div>
      ...
      bannerList: [
        {
          id:1,
          linkUrl: '/course',
          imageUrl: 'https://edu-xulo.oss-cn-shanghai.aliyuncs.com/153525d0ef15459596.jpg',
        },
        {
          id:2,
          linkUrl: '/teacher',
